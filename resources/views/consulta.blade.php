                                ...
                                <!-- TABELA -->
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>  
                                                <td>{{ $tblAgendamentos->nome }}</td>
                                                <td>{{ $tblAgendamentos->telefone }}</td>
                                                <td>{{ $tblAgendamentos->origem }}</td>
                                                <td>{{ $tblAgendamentos->data_contato }}</td>
                                                <td>{{ $tblAgendamentos->observacao }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
